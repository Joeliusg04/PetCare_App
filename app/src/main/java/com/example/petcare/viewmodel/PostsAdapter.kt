...
class PostsAdapter (private var posts: List<Post>, private val listener: com.example.petcare.viewmodel.OnClickListener):RecyclerView.Adapter<PostsAdapter.ViewHolder>() {
